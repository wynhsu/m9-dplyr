...
team.data <- mutate(team.data, Turnover_Steal = TOV/STL)

# Sort the teams from lowest turnover/steal ratio to highest
# Which team has the lowest ratio?
team.data <- arrange(team.data, Turnover_Steal)
lowest.ratio <- team.data$Team[team.data$Turnover_Steal==min(team.data$Turnover_Steal)]
...
team.data <- mutate(team.data, Assist_per_game = AST/G)
team.data <- arrange(team.data, desc(Assist_per_game))
